...
JSON으로만:
{
  "summary": "재회운 총평 — 두 사람의 인연 흐름과 재회 가능성 한 문장 (100자)",
  "cause": "이별 원인 분석 — 사주적 갈등 패턴·감정 표현 차이·반복 패턴 (120자)",
  "other_after": "상대의 이별 후 흐름 — 미련 가능성·연락 망설이는 이유 (100자)",
  "my_after": "나의 이별 후 흐름 — 내 감정 패턴·조심할 점 (80자)",
  "possibility": "재회 가능성 — 높음/보통/낮음 중 하나와 그 이유 (80자)",
  "contact": "연락운 — 누가 먼저 할지·연락 오는 방식·기다릴 때 조심할 점 (100자)",
  "if_reunion": "재회가 된다면 — 좋아질 점·다시 반복될 문제·확인해야 할 것 (100자)",
  "attitude": "재회를 위한 태도 — 해야 할 행동·하지 말아야 할 행동·대화 방식 (100자)",
  "recommend": "재회를 추천하는 경우 — 3가지 (80자)",
  "caution": "재회를 조심해야 하는 경우 — 3가지 (80자)",
  "final": "최종 조언 — 재회보다 중요한 나의 안정감과 앞으로의 선택 (80자)"
}`;
