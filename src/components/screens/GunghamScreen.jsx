...
{
  "score": 0~100 숫자만,
  "tagline": "두 사람 관계를 비유로 표현한 한 줄 (예: 예리한 보석과 단단한 도끼가 만드는 짜릿한 스파크)",
  "summary": "두 사람의 전체적인 관계 분위기. 어떻게 끌리고, 어떤 안정감이 있으며, 어디서 조율이 필요한지. 두 이름 직접 언급",
  "ilgan": "두 사람 일간 관계. 서로를 어떻게 인식하는지, 성격적으로 잘 맞는 부분과 자존심이 부딪히는 부분",
  "ilji": "일지 궁합. 실제로 가까워졌을 때의 느낌, 연애 중 반복될 수 있는 갈등, 정서적 안정감 여부",
  "element": "오행 궁합. 서로에게 보완되는 오행, 부딪히는 오행, 관계에서 균형 잡는 방법 구체적으로",
  "conflict": "갈등 패턴. 자주 부딪히는 주제, 싸울 때 각자 보이는 모습, 관계 불안정해지는 원인. 실생활 예시 포함",
  "strength": "관계의 장점. 함께 있을 때 좋아지는 것, 서로에게 배울 수 있는 점, 함께하면 시너지 나는 분야",
  "love_style": "두 사람의 연애 스타일 차이. 각자 원하는 것과 표현 방식의 차이, 오해가 생기기 쉬운 지점",
  "final": "이 관계를 좋게 만들기 위한 핵심 조언. 두 이름 각각에게 구체적인 실천 팁",
  "keyword": "끌림, 긴장감, 성장 (예시처럼 키워드만 3개)"
}`;
